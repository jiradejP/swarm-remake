...
import { getMailByReceiverAndPrivate } from '../Utils/firebaseDatabase.js';
import MailList from './Dashboard/MailList';

class InboxPrivate extends Component {
    constructor() {
        super();
        this.state = {
        ...
        getCurrentUser().then((user) => {
            ...
            getMailByReceiverAndPrivate(user.email).then((mails) => {
                this.setState(prevState => ({
                    mails: mails
                }));
            })
    ...
    refreshAllMail = () => {
        return new Promise((resolve, reject) => {
            getMailByReceiverAndPrivate(this.state.user.email).then((mails) => {
                this.setState(prevState => ({
                    mails: mails
                }), () => {
                    this.forceUpdate();
            ...
            <div id="InboxPrivate">
                ...
                <div className="container is-fluid">
                    <div className="columns">
                        <Aside page="inboxprivate" openWriteBox={this.openWriteBox} />
                        <div className="column is-10 content">
                            <h2>เอกสารส่วนตัวที่ส่งมาถึงคุณ</h2>
